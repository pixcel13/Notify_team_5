        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12  col-md-6">
                   <div class="updates">
                        <?php $url = $f_notified['video_n'];?>
                         <h3> <?php echo $f_notified['titulo_n']; ?> </h3>
                        <p><?php echo $f_notified['texto_n']; ?></p>
                        <form>
    ...
    <section id="testimonials">
        <div class="container">
          ...
          <!-- Quote n --> 
                    ...
                    <?php 
                        $texts = array("Say Hi & Get in Touch", "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suspendisse.");
                       ?>   
                     <div class="social text-center">
                         <h3><?php echo $texts[0]; ?></h3>
                         <p><?php echo $texts[1]; ?></p>  
                         <ul>
    ...
    <footer id="footer">
        <div class="container">
            <ul>
                ...
                <li><a href="./login.html">Backend</a></li>
            </ul>
        </div>
    </footer>
    <!-- End Footer -->
